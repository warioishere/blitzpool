...
- New `/api/info/rejected` endpoint lists rejected share reasons pool-wide
- New `/api/client/<btc_address>/rejected` shows rejected reasons for a specific address
